...
public:
    ...
    // FIXME: This is never used. The deviceController is teh source of truth, so we never
    // need to ask what the state is, the controller simply makes sure it is set accordingly.
    bool IsLocked();
