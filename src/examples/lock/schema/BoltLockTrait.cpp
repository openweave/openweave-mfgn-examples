...
uint8_t IsNullableHandleBitfield[] = { 0xe8 };

//
// IsEphemeral Table
//

uint8_t IsEphemeralHandleBitfield[] = { 0x88 };
...
const nl::FieldDescriptor BoltActuatorStateChangeEventFieldDescriptors[] = {
    ...
    { &Schema::Weave::Trait::Security::BoltLockTrait::BoltLockActorStruct::FieldSchema,
      offsetof(BoltActuatorStateChangeEvent, boltLockActor), SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 0), 4 },

};

const nl::SchemaFieldDescriptor BoltActuatorStateChangeEvent::FieldSchema = {
    .mNumFieldDescriptorElements =
        sizeof(BoltActuatorStateChangeEventFieldDescriptors) / sizeof(BoltActuatorStateChangeEventFieldDescriptors[0]),
