...
// and one part that is specific to the device.

#ifndef WEAVE_PROJECT_CONFIG_H
#define WEAVE_PROJECT_CONFIG_H

#if BUILD_RELEASE // pseudo-release build
 ...
 */
#define WEAVE_DEVICE_CONFIG_ENABLE_TEST_DEVICE_IDENTITY 35
 ...
 *
 * 0xFE02: SDK Sample Open Close Resource
 */
#define WEAVE_DEVICE_CONFIG_DEVICE_PRODUCT_ID 0xFE02
...
#else
#define WEAVE_DEVICE_CONFIG_DEFAULT_TELEMETRY_INTERVAL_MS (10 * 60 * 1000) // 10 minutes
#endif                                                                     // BUILD_RELEASE
